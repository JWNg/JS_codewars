...
FUNDAMENTALSOBJECTSMAP/REDUCEALGORITHMS

const find = (object, path) => path.split('.').reduce((accum, val)=>{return !accum||!accum.hasOwnProperty(val)?undefined:accum[val]}, object)
