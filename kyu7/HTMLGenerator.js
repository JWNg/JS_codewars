...
PUZZLESFUNCTIONAL PROGRAMMINGDECLARATIVE PROGRAMMING
...
function HTMLGen () {
  this.p = (str) => { return "<p>"+ str + "</p>"};
  this.a = (str) => { return "<a>"+ str + "</a>"};
  this.b = (str) => { return "<b>"+ str +"</b>"};
  this.body = (str) => { return "<body>"+ str + "</body>"};
  this.div = (str) => { return "<div>"+ str + "</div>"};
  this.span = (str) => { return "<span>"+ str + "</span>"};
  this.title = (str) => { return "<title>"+ str + "</title>"};
  this.comment = (str) => { return "<!--"+ str + "-->"};
}
